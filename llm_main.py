...
from env.translation_agent import FrozenLakeAgent
...
if __name__ == "__main__":
    ...
    hyperparams = {
        ...
        "model_name": "/gemini/pretrain/Qwen2.5-7B-Instruct",
        ...
        "batch_size": 1,
        "seed": 42069,
        "n_episodes": 200,  # 5000, #CartPole: 50m for 1 eps (length 39) for 32B, 36m (31 steps) for 7B, 15-25 steps for rand. Pong: 5.5h for 1 episode (500 length) on 7B with CoT, 9h for 32B
    ...
    for episode in trange(hyperparams["n_episodes"]):
        ...
        log_interval = max(1, hyperparams["n_episodes"] // 10)
